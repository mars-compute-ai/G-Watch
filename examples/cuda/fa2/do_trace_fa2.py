...
# Default kernel regex for FA2 forward kernel on SM80
fa2_kernel_regex = ".*flash_fwd.*"
...
def main():
    parser = argparse.ArgumentParser(description="Trace FlashAttention2 kernels with do_trace.")
    ...
    parser.add_argument("--kernel-regex", type=str, default=fa2_kernel_regex)
    parser.add_argument("--warmup", type=int, default=25)
    parser.add_argument("--rep", type=int, default=100)
    parser.add_argument("--dump-path", type=str, default="./fa2_trace.gwatch")
