...
def main():
    parser = argparse.ArgumentParser(description="PC sampling for Triton FlashAttention2 with do_pc_sampling.")
    ...
    parser.add_argument(
        "--dump-path",
        type=str,
        default="./fa2_triton_pc_sampling.gwatch",
    ...
    # Warmup (including Triton JIT compilation)
    with torch.no_grad():
