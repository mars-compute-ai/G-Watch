...
def main():
    parser = argparse.ArgumentParser(description="Range profile FlashAttention3 with do_range_profile.")
    ...
    parser.add_argument(
        "--metrics",
        type=str,
        default="FBSP.TriageCompute.dramc__cycles_elapsed.avg",
    ...
    parser.add_argument(
        "--dump-path",
        type=str,
        default="./fa3_range_profile.gwatch",
    ...
    def run_once():
        if args.backward:
            o = flash_attn_func_v3(q, k, v, causal=args.causal)
